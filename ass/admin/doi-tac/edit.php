...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="from-group">
    <label>Url</label>
    <textarea rows="10" class="form-control" name="url"><?= $brand['url']?></textarea>
    <?php 
  ...
  <div class="col-md-6">
      <div class="row">
        ...
        <img id="showImage"  src="<?= $siteUrl . $brand['image']?>" width="300" class="img-responsive"> 
      </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    img.onchange = function(){
      ...
      if(anh == undefined){
        document.querySelector('#showImage').src ="<?= $siteUrl. $brand['image']?>";
      }else{
