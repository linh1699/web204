...
<head>
  ...
  <title>AdminLTE 2 | Sửa Khách Hàng</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <form action="<?= $adminUrl ?>lien-he/save-edit.php" method="post" enctype="multipart/form-data">
    ...
    <div class="from-group">
    <label>Mô tả</label>
    <textarea rows="10" class="form-control" name="conten"><?= $contact['conten']?></textarea>
    <?php 
    if (isset($_GET['errName'])){
     ?>
     <span class="text-danger"><?php echo $_GET['errName'] ?></span>
